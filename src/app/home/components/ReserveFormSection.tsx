 ...
 * ReserveFormSection
 *
 * MAKE WEBHOOK SETUP (required for submissions to be delivered):
 *
 * 1. Create a Make.com webhook (or compatible POST endpoint)
 * 2. Create / update .env.local with the server-side URL, never NEXT_PUBLIC_*:
 *
 *      MAKE_WEBHOOK_URL=https://hook.eu2.make.com/<your-webhook-id>
 *
 * 3. In Cloudflare, store MAKE_WEBHOOK_URL as an encrypted secret.
 */

import React, { useState, useEffect } from 'react';
import Icon from '@/components/ui/AppIcon';
import { WhatsAppMark } from '@/components/icons/WhatsAppMark';
// Form submissions go through /api/lead so the webhook URL stays server-side only.
